<template>
  ...
  >
    <div class="container">
      <div class="contents">
        <el-skeleton :loading="loadingFirst" class="skeleton-navbar">
        ...
        <div style="display: contents" v-show="showFirst">
          <div v-if="width > 991" class="navbar-top">
            ...
            <nuxt-link :to="`/info/about`"> О нас </nuxt-link>
            <nuxt-link :to="`/info/dostavka`"> Доставка товаров </nuxt-link>
          ...
          <div class="header-nav">
            ...
            <div class="nav-header-cat" v-click-out="closeDropdown">
              <el-button slot="reference" class="header-cat" @click="menyCat()">
                <span
                  v-show="iconCat == true"
                  class="button-svg-index-cat"
                ></span>
                <span
                  v-show="iconCat == false"
                  class="button-svg-index-cat-icon"
                >
            ...
            <client-only>
              ...
              <div class="nav-button-basket button-nav-meny">
                <el-button type="text" @click="toggleModal(true)">
                  ...
                  <span v-if="width > 991" class="button-nav-text"
                    >Корзина</span
                  >
                </el-button>
              </div>
            ...
            <div v-if="width > 991" class="button-nav-meny">
              <TimelineModal :worktime.sync="worktime" />
            </div>
    ...
    <div
      v-if="width > 991"
      :class="[visible == true ? 'header-bg-popover-none' : '']"
    ></div>
    <client-only>
      <vue-bottom-sheet
        max-width="400px"
      ...
      <div v-if="width < 991" class="bottom-bar">
        <div class="container">
          <div class="bottom-bar-con">
            ...
            <el-button circle icon="el-icon-more-outline" @click="open()">
            </el-button>
            <TimelineModal :worktime.sync="worktime" />
    ...
    <PhoneModal :dialogVisible.sync="dialogVisible" :phones.sync="phones" />
  </header>
</template>
  ...
  methods: {
    ...
    openNotify() {
      this.$notify({
        ...
        duration: 5500,
        message:
          "На Вашу почту была выслана информация о заказе! В ближайшее время с Вами свяжется менеджер для уточнения деталей заказа.",
      });
    },
    updateWidth() {
    ...
    open2() {
      this.$notify({
        ...
        message:
          "<strong>13.05.23 <br>график работы склада: <br>- до 14.00</strong>",
        type: "warning",
        duration: 50000,
      });
    },
