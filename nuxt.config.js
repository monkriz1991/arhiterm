...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: "google", content: "notranslate" },
      {
        ...
        content: "pffvbs0GyslCUgg16m88GzyCeE8tIXtFV8_yrWKWKhQ",
      },
      {
        name: "google-site-verification",
        content: "XXP2MkYaAs0LKj5RuVVah-wMhFxrUmfV5rOUu9qihSY",
      },
  ...
  sitemap: {
    ...
    sitemaps: [
      {
        exclude: ["/cabinet", "/cabinet/**", "/userCabinet", "/userCabinet/**"],
      ...
      },
      {
        ...
        routes: async () => {
          const { data } = await axios.get(
            "https://new.arhiterm.by/catalog/categories/?limit=999"
          );
          return data.results.map(
            (category) => `/catalog/${category.kirilica_name}`
          );
        },
      },
      {
        ...
        routes: async () => {
          const { data } = await axios.get(
            "https://new.arhiterm.by/catalog/search/?limit=9999999"
          );
          return data.results.map(
            (product) => `/product/${product.kirilica_name}`
          );
        },
      },
      {
        ...
        routes: async () => {
          const { data } = await axios.get(
            "https://new.arhiterm.by/manufacturer/get/?is_active=true&limit=99999"
          );
          return data.results.map(
            (factory) => `/factory/${factory.kirilica_name}`
          );
        },
      },
    ],
